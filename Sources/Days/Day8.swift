...
class Day8: BaseDay {
    ...
    override func part1() -> Int {
        ...
        let pairs = createJunctionBoxPairs(junctionBoxes).min(
            count: self.connections, sortedBy: { a, b in a.distance < b.distance })
    ...
    override func part2() -> Int {
        ...
        let pairs = createJunctionBoxPairs(junctionBoxes).sorted { a, b in a.distance < b.distance
        }
        ...
        for closestPair in pairs {
            ...
            if circuits.filter({ $0.count == junctionBoxes.count }).count == 1 {
                return closestPair.a.x * closestPair.b.x
            }
        }
